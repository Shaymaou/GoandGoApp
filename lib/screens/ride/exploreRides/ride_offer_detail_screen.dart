import 'package:goandgoapp/cloud_functions/firebase_function.dart';
import 'package:goandgoapp/models/types/requested_offer_status.dart';
import 'package:goandgoapp/models/user_model.dart';
import 'package:goandgoapp/providers/user_state.dart';
import 'package:goandgoapp/screens/chat/chat.dart';
import 'package:goandgoapp/utils/utils.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:goandgoapp/models/ride_offer_model.dart';
...
class RideOfferDetailScreen extends StatefulWidget {
  ...
  const RideOfferDetailScreen({super.key, required this.userState, required this.rideOffer, this.refreshOffersKey});
  @override
...
class RideOfferDetailScreenState extends State<RideOfferDetailScreen> {
  ...
  Widget buildOtherRideOfferActions(BuildContext context, UserState userState, UserModel currentUser) {
    final requestedUserIds = widget.rideOffer.requestedUserIds;
    final requestedOfferStatus = requestedUserIds != null ? requestedUserIds[currentUser.email] : null;
    ...
    return currentUser.requestedOfferIds.contains(widget.rideOffer.id)
        ? Column(
            children: [
              ...
              const SizedBox(height: 8.0),
              Text('Ride ${describeEnum(requestedOfferStatus as Object)}!',
                  style: TextStyle(
